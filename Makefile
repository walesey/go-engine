...
testintall:
	...
	go get -t github.com/walesey/go-engine/emitter
...
test: testintall
	...
	go test github.com/walesey/go-engine/emitter
...
coverage: testintall
	...
	go test github.com/walesey/go-engine/emitter -coverprofile=$(COVER_DIR)/emitter.cover.out && \
